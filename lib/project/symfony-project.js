/** @babel */
/* global Promise process __dirname */
...
export default class SymfonyProject
{
   ...
   *
   * @param  {String|Array} command - The command and options to run
  ...
  execute (command, options) {
   ...
   return new Promise((resolve, reject) => {
     ...
     this.subProcess = spawn(command[0], command.splice(1), {cwd: this.root})
