...
export default class SymfonyCommandEditor {
  constructor(props) {
    this.hints = []
    this.props = props
    this.hintEnabled = props.enableHints === false || true
    ...
    this.disposables.add(this.refs.commandEditor.onDidChange(() => {this.updateHints({hints: this.props.items})}))
